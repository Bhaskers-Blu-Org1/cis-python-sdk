...
"""
Summarized analytics data for Range applications
"""
...
class RangeAnalyticsSummaryV1(BaseService):
    """The Range Analytics Summary V1 service."""

    DEFAULT_SERVICE_URL = 'https://api.cis.cloud.ibm.com'
    DEFAULT_SERVICE_NAME = 'range_analytics_summary'
    ...
    def new_instance(cls,
                    ...
                    ) -> 'RangeAnalyticsSummaryV1':
        """
        Return a new client for the Range Analytics Summary service using the
    ...
    def __init__(self,
        ...
        """
        Construct a new client for the Range Analytics Summary service.
    ...
    def get_range_analytics_summary(self, *, accept: str = None, metrics: List[str] = None, dimensions: List[str] = None, filters: str = None, sort: List[str] = None, since: datetime = None, until: datetime = None, **kwargs) -> DetailedResponse:
        """
        Get summarized analytics data for Range applications.
        ...
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME, service_version='V1', operation_id='get_range_analytics_summary')
        ...
        url = '/v1/{0}/zones/{1}/range/analytics/events/summary'.format(*self.encode_path_vars(self.crn, self.zone_identifier))
...
class GetRangeAnalyticsSummaryEnums:
    """
    Enums for get_range_analytics_summary parameters.
    """
